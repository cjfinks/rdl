...
\end{align}
%
commonly known in the literature as the \emph{spark condition}. As it turns out, even if $A$ is unknown a priori this condition is enough to guarantee that both $A$ and the $\mathbf{a}_i$ are robustly identifiable from enough sufficiently diverse samples $\mathbf{y}_i$.
