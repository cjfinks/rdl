...
We state here the main implications of our probabilistic results (Theorems \ref{Theorem2} and \ref{Theorem3}). To keep our exposition simple, our probabilistic statements are based upon the following elementary construction of \emph{random sparse vectors} (although many ensembles will suffice, e.g. \cite[Sec.~\S 4]{baraniuk2008simple}).
