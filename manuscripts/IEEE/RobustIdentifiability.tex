...
\end{align}
%
then we satisfy the robust identifiabiltiy criteria of Def. \ref{Uniqueness}. The constant $C$ is defined in terms of $A$ and the $\mathbf{a}_i$ in \eqref{Cdef}, below. 
