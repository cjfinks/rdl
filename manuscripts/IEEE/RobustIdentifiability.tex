...
\begin{align}
\|A - BPD\|_2 \leq \left(  \frac{k^{2/3}}{\alpha_{2k}(A)\phi_k(A)\rho} \right) \max_i \|\mathbf{y}_i - B\mathbf{b}_i\|
\end{align}
%
...
\|\mathbf{b}_i - PD\mathbf{a}_i\|_1 \leq \frac{ \|D\|_2}{\alpha_{2k}(A)}  \left( 1 + \frac{k^{2/3}}{\alpha_{2k}(A)\phi_k(A)\rho}\|D^{-1}P^{-1}\mathbf{b}_i\|_1 \right) \max_i \|\mathbf{y}_i - B\mathbf{b}_i\|.
\end{align}
\end{remark}
...
\end{align}
%
where $\Delta = \frac{\varepsilon k^{2/3}}{\alpha_{k}(A)\sigma\phi_k(A)} < \frac{\alpha_{k}(A)}{\sqrt{2}}$. It follows by Lemma \ref{MainLemma} that there exists a permutation matrix $P \in \mathbb{R}^{m \times m}$ and a diagonal matrix $D \in \mathbb{R}^{m \times m}$ such that for all $i \in \{1, \ldots, m\}$,
$\|A - BPD\|_2 \leq C\varepsilon$ for $C = \frac{k^{2/3}}{\alpha_{k}(A)\sigma\phi_k(A)}$.
\end{proof}
