...
Given that a robust version of uniqueness in SCA is possible, it would be useful to determine the best dependence of $\delta_1, \delta_2$ on $\varepsilon$ possible as well as the minimum possible samples size $N$.  In the case of $k = 1$, the best possible bounds are given by [********  CHAZ?? ***********].  We encourage the sparse coding community to extend our results and find a tight dependency of all the parameters, both for the sake of theory and practical applications.
