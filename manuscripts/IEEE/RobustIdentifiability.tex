...
An important consequence of this result is that for sufficiently small reconstruction error, the original dictionary and sparse vectors are determined up to a commensurate error, independent of alternate representation. In other words, if $\varepsilon = \varepsilon(\delta_1, \delta_2)$, where
