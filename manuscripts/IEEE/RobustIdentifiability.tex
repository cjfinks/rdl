...
\end{align}
%
then $A$ and the $\mathbf{a}_i$ are robustly identifiable by Def. \ref{Uniqueness}. The constant $C$ is defined in terms of $A$ and the $\mathbf{a}_i$ in \eqref{Cdef}, below. 
