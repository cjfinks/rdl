...
which is evidently a necessary condition given that the $\mathbf{a}_i$ are known only to be $k$-sparse.\footnote{For example, consider $A$ with collinear columns.} %TODO: Make PERFECT
