...
\end{proof}
% TODO: We don't have access to \pi, though, when applying the theorem -- so maybe we should state how to bound it? (by checking all {m choose k} supports not just those in pi[T])
