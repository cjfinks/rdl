...
|\mathbf{y}_i - B\mathbf{x'}_i|_2 \leq \varepsilon,\indent \text{for } i = 1, \ldots, N,
\end{align}
%
...
|A_j - (BPD)_j|_2 \leq \delta_1 \ \ \text{and} \ \ |\mathbf{x}_i - D^{-1}P^{\top}\mathbf{x'}_i|_1 \leq \delta_2.
\end{align}
\end{definition}
