...
Support was provided, in part, by the National Science Foundation grant IIS-1219212 (CH, CG) and the Statistical and Applied Mathematical Sciences Institute, under grant NSF DMS-1127914 (CH, CG).}}
...
The significant finding of this work is that any dictionary satisfying the spark condition from compressed sensing is uniquely identifiable from enough sparse noisy linear combinations of its elements up to an error linear in the noise (Thm.~\ref{DeterministicUniquenessTheorem}).
