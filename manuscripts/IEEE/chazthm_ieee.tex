...
The strategy above can be easily modified to prove the following variation of Lem.~\ref{MainLemma}, key to proving Thm.~\ref{DeterministicUniquenessTheorem2}. Let $\pi[T]$ denote the set $\{ \pi(S): S \in T\}$. 
