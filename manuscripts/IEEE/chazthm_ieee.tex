...
which is evidently a necessary condition given that the $\mathbf{a}_i$ are known only to be $k$-sparse.\footnote{For example, consider rank $1$ dictionaries $A$.} %  with collinear columns.} %TODO: Make PERFECT
