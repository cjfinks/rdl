...
Let $Y = \{\mathbf{y}_1, \ldots, \mathbf{y}_N \} \subset \mathbb{R}^n$ be a $k$-sparse representation in $\mathbb{R}^m$.  When does $Y$ have a stable $k$-sparse representation in $\mathbb{R}^m$?
\end{question}
